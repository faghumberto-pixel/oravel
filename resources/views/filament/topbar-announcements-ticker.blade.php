{{-- Avisos (2026-09-18): extraido de topbar-brand-and-ticker.blade.php pra
     poder renderizar sozinho, centralizado no topbar, sem depender do bloco
     de logo (que so' aparece em modo topNavigation() -- ver
     vendor/filament-panels/components/topbar/index.blade.php). Mesma fonte/
     logica de resources/views/filament/announcement-banner.blade.php
     (aposentado -- os avisos saem do banner de pagina inteira e passam a
     aparecer aqui). --}}
@php
