...
@if ($user && method_exists($user, 'isSuperAdmin') && $user->isSuperAdmin() && ! \App\Support\Tenancy::current())
    <div class="fi-acting-tenant-banner mb-4 rounded-lg border border-warning-300 bg-warning-50 px-4 py-3 text-sm text-warning-800 dark:border-warning-500/30 dark:bg-warning-500/10 dark:text-warning-300">
