{{-- Este footer usa canViewAny()/canAccess() de varios Resources, que pressupoem
     usuario autenticado (guest sempre resolve pra false/exception dependendo da
     policy) -- so faz sentido dentro do painel logado. Sem essa guarda, o
     renderHook(PanelsRenderHook::FOOTER) global (AdminPanelProvider) tambem injeta
     esse bloco inteiro na tela de Login/registro/reset de senha, quebrando o
     layout dessas paginas (guest nao tem contexto de tenant/permissoes pra
     filtrar os links de qualquer forma). --}}
@auth
    <footer class="mt-20 bg-transparent">
