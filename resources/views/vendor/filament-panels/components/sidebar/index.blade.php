{{--
    Override de vendor/filament/filament/resources/views/components/sidebar/index.blade.php
    (Laravel resolve resources/views/vendor/{package}/... antes do pacote, sem tocar em vendor/).

    Unica mudanca vs o original: classe "dark" fixa no <aside> (linha da
    classe fi-sidebar), mesmo truque ja usado no override do topbar
    (resources/views/vendor/filament-panels/components/topbar/index.blade.php --
    ver o comentario historico la' pra explicacao completa). Precisa disso
    porque a sidebar agora e' sempre azul-escuro (pedido do usuario
    2026-09-18, cor real em brand-header-background.blade.php via CSS puro
    no .fi-sidebar), independente do tema claro/escuro escolhido -- sem
    esse ancestral com classe "dark", os textos/icones dos itens do menu
    (que usam classes tipo "text-gray-700 dark:text-gray-200") ficariam
