...
@php
    ...
    // Ícone antes do rótulo de cada menu-pai (2026-09-23, pedido do usuario).
    // NÃO usa a prop $icon nativa do Filament de propósito: setar
    // NavigationGroup::icon() aciona a lógica acima ($hasDropdown) que
    // REMOVE o ícone de TODOS os itens filhos do grupo quando o sidebar é
    // colapsável (sidebarCollapsibleOnDesktop, ligado neste painel) -- ver
    // o `if ($icon) { ... $itemIcon = null; ... }` mais abaixo neste mesmo
    // arquivo. Esse mapa é só cosmético, isolado, sem esse efeito colateral.
    $groupIcons = [
        'PMP' => 'heroicon-o-calendar-days',
        'Conformidade NR-13' => 'heroicon-o-shield-exclamation',
        'Manutenção' => 'heroicon-o-wrench-screwdriver',
        'Logística' => 'heroicon-o-truck',
        'Ativos e Materiais' => 'heroicon-o-cube',
        'Equipe' => 'heroicon-o-users',
        'Departamento Pessoal' => 'heroicon-o-identification',
        'Comercial' => 'heroicon-o-briefcase',
        'Financeiro' => 'heroicon-o-banknotes',
        'Relatórios' => 'heroicon-o-chart-bar',
        'Configurações' => 'heroicon-o-adjustments-horizontal',
    ];
    $groupLabelIcon = $groupIcons[$label] ?? null;
@endphp
