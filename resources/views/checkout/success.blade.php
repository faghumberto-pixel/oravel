...
<html lang="pt-BR">
    <head>
        ...
        <title>Pagamento em confirmação -- Oravel</title>
            ...
            <div class="relative z-10 flex min-h-screen flex-col items-center justify-center px-6 py-12">
                ...
                <div class="w-full max-w-md rounded-3xl border border-white/25 bg-white/15 p-8 text-center shadow-2xl backdrop-blur-xl sm:p-10">
                    <span class="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full border border-white/30 bg-white/10">
                        <x-heroicon-o-check-circle class="h-7 w-7 text-white" />
                    </span>

                    <h1 class="text-xl font-bold text-white">Pagamento recebido pela Asaas</h1>

                    <p class="mt-3 text-sm text-white/75">
                        Estamos confirmando seu pagamento. Assim que a confirmação chegar (normalmente em
                        poucos minutos), seu acesso ao painel Oravel é liberado automaticamente e você
                        recebe um e-mail. Não é preciso fazer mais nada por aqui.
                    </p>

                    <a href="https://oravel.com.br"
