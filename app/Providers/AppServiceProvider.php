...
use App\Observers\ClientMessageObserver;
...
use App\Observers\MaterialRequestQuotationItemObserver;
...
use App\Observers\SupplierEvaluationObserver;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        ClientMessage::observe(ClientMessageObserver::class);
        ...
        MaterialRequestQuotationItem::observe(MaterialRequestQuotationItemObserver::class);
        SupplierEvaluation::observe(SupplierEvaluationObserver::class);
