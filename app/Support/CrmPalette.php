 ...
 *
 * 'soft' usa opacidade /25 em dark mode (era /10 até 2026-08-05) -- o
 * painel Central roda com darkMode(true, isForced: true) sempre, então só
 * a variante dark: conta de fato (a classe bg-{cor}-50 sem prefixo nunca
 * se aplica com .dark ativo). Em /10 sobre o fundo escuro do painel
 * (~rgb(24,33,48)) o destaque ficava imperceptível -- usuário via "tudo
 * branco/cinza contínuo" mesmo com a classe presente no HTML.
 */
class CrmPalette
{
    /**
    ...
    public static function stage(?string $stage): array
    {
        return match ($stage) {
            ...
            SalesLead::STAGE_DEMONSTRACAO_REALIZADA => [
                ...
                'soft' => 'bg-purple-50 dark:bg-purple-500/25',
                'dot' => 'bg-purple-500',
            ...
            default => [
                ...
                'soft' => 'bg-gray-50 dark:bg-gray-500/25',
                'dot' => 'bg-gray-500',
                'ring' => 'ring-gray-400',
            ],
        };
    ...
    public static function segment(?string $segment): array
    {
        return match ($segment) {
            Client::NICHE_EVENTOS => [
                ...
                'soft' => 'bg-pink-50 dark:bg-pink-500/25',
                'dot' => 'bg-pink-500',
            ...
            Client::NICHE_INDUSTRIAL_HOSPITALAR => [
                ...
                'soft' => 'bg-cyan-50 dark:bg-cyan-500/25',
                'dot' => 'bg-cyan-500',
                'hex' => '#0891b2',
            ],
            Client::NICHE_CONSTRUCAO_CIVIL => [
                ...
                'soft' => 'bg-amber-50 dark:bg-amber-500/25',
                'dot' => 'bg-amber-500',
                'hex' => '#d97706',
            ],
