...
class MaintenanceOrder extends Model implements HasMedia
{
    ...
    protected $fillable = [
        ...
        'client_signature', 'technician_signature', 'status', 'internal_status', 'commercial_status', 
    ...
    public function parts(): HasMany { return $this->hasMany(MaintenanceOrderMaterial::class, 'maintenance_order_id'); }
