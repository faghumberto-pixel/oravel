...
|---|---|---|
| `ANALYTICS_GA` / `ANALYTICS_CLARITY` | `false` | Google Analytics 4 e Microsoft Clarity foram removidos de **todas** as páginas públicas em 21/09/2026 (83 páginas verificadas ao vivo). Se voltarem a ser usados, ligue as flags e publique o aviso de cookies com consentimento. |
...
1. ~~Aviso de cookies~~ Resolvido: sem Clarity/Google Analytics, só resta o cookie próprio de visitas (`TrackSiteVisit`) e os essenciais; reavalie o aviso se voltar a usar rastreadores.
